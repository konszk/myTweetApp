            ...
            <div class="side-menu">
                ...
                <nav>
                    <ul class="main-nav">
                        ...
                        <li class="item" id="selected"><a href="/docoTsubu/Main"># home</a></li>
                    ...
                    <div class="tweet-list">
						...
						<% for (Mutter mutter : mutterList) { %>
								<div class="tweet-item">
									<div class="icon">
										<!-- <img src="image/default_icon.jpg" width="50px"> -->
									...
									<div class="tweet-info">
										<div class="time-wrapper">
											...
											<div class="bookmark">
												<% if (mutter.getBookmark() == true) { %>
													<img id="bookmark-<%= mutter.getId() %>" src="./image/bookmark.jpg" alt="お気に入り" onclick="changeImg(this.id)">
												<% } else { %>
													<img id="bookmark-<%= mutter.getId() %>" src="./image/not_bookmark.png" alt="お気に入り" onclick="changeImg(this.id)">
												<% } %>
											</div>
										</div>
										<div class="tweet">
            ...
            <div class="box-wrapper">
                <div class="tweet-box">
                    <form action="/docoTsubu/Main" method="POST">
                        <input type="text" name="text" placeholder="    Type Tweet">
